...
1. Сбор моделей Android: Список устройств задаётся вручную в файле `generator.py` (переменная `android_models`). Модели выбираются случайным образом для генерации User-Agent строки.
